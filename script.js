...
/* =========================================================
   منهج علم الأبيولوجيا — لا، منهج علم الأحياء (3 مستويات)
   ========================================================= */
/* =========================================================
...
const BIOLOGY_CURRICULUM = [
  {
    ...
    units: [
      ...
      { title: "استكشاف علم الأحياء من خلال المحاكاة", keywords: ["التعلم القائم على المحاكاة", "محاكيات PhET", "تباين الصفات", "ديناميكيات الجماعة", "نماذج الانتخاب الطبيعي", "سيناريوهات التغير البيئي"] },
      { title: "موارد المعلم", keywords: ["معايير NGSS", "أدلة الوحدات", "الأنشطة العملية", "التجارب الصفية", "تخطيط الدروس", "إشراك الطلاب", "التقييم التكويني"] }
    ]
  },
  {
    name: "المستوى الثاني",
    units: [
      ...
      { title: "استكشاف علم الأحياء من خلال المحاكاة", keywords: ["التعلم القائم على المحاكاة", "نماذج التعبير الجيني", "نماذج تأثير الاحتباس الحراري", "ديناميكيات الجماعة", "سيناريوهات التغير البيئي"] }
    ]
  },
  {
    name: "المستوى الثالث",
    units: [
      ...
      { title: "استكشاف علم الأحياء من خلال المحاكاة", keywords: ["نماذج الانتشار", "محاكيات جهد الفعل", "نماذج التعبير الجيني", "محاكيات توازن هاردي-واينبرغ", "ديناميكيات الجماعة", "سيناريوهات التغير البيئي"] }
    ]
  }
];

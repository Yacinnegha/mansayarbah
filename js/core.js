...
function showScreen(name) {
  ...
  // إعادة التمرير إلى أعلى الصفحة عند كل تنقّل بين الشاشات
  // (يمنع بقاء إزاحة تمرير قديمة من الشاشة السابقة — خاصة على الهاتف
  //  حيث كانت الشاشة الجديدة تبدو "مزاحة" ويقفز التمرير عند أول لمسة)
  window.scrollTo(0, 0);
...
/* ====== منع قفزة الشاشة عند اللمس على الهاتف ======
   على الأجهزة اللمسية، يؤدي التركيز التلقائي على الأزرار عند اللمس
   إلى تمرير الصفحة قسراً "لكشف العنصر" فتتحرك الشاشة قليلاً.
   نلغي السلوك الافتراضي لـ pointerdown على العناصر التفاعلية فقط،
   وبذلك لا يتلقى العنصر focusاً عند اللمس (النقر click يعمل كالمعتاد
   والتنقل بلوحة المفاتيح Tab + Enter غير متأثر). */
document.addEventListener("pointerdown", (e) => {
  const interactive = e.target.closest("button, a, .btn, .ttt-cell, .game-card, [role='button'], [role='gridcell']");

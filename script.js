...
function claimForfeitWinNow() {
  if (!battleState.socket) return;
  sounds.click();
  // عطّل الزرين مؤقتاً لمنع النقر المزدوج
  const claimBtn = document.getElementById("forfeit-claim-btn");
  const continueBtn = document.getElementById("forfeit-continue-btn");
...
function handleBattleQuestion(data) {
  ...
  // أخفِ أي عرض فوز بالتخلف من سؤال سابق (تم رفضه)
  hideForfeitOffer();

...
function startGame(modeId) {
  ...
  document.getElementById("game-mode-name").textContent = `${mode.icon} ${mode.name}${islamicBadge}`;
  ...
  if (card) card.classList.remove("source-ai", "source-bank", "source-ai-islamic", "source-islamic-bank");
...
const ISLAMIC_PARAGRAPHS = [
  { topic: "العقيدة", title: "التمسك بما كان عليه الصحابة", content: "هو الأصل الأول الذي يقوم على اتباع ما كان عليه أصحاب رسول الله ﷺ والاقتداء بهم في فهم الدين", keywords: ["اتباع", "صحابة", "اقتداء"] },
  ...
  { topic: "العقيدة", title: "إثبات اليدين لله", content: "لله يدان حقيقتان كما يليق بجلاله، {بَلْ يَدَاهُ مَبْسُوطَتَانِ}", keywords: ["يدان", "صفات", "حقيقة"] },
  { topic: "العقيدة", title: "إثبات الوجه لله", content: "لله وجه موصوف بالجلال والإكرام ليس كمثله شيء", keywords: ["وجه", "صفات", "إكرام"] },
  { topic: "العقيدة", title: "إثبات العينين لله", content: "لله عينان تليقان بجلاله، {تَجْرِي بِأَعْيُنِنَا} بلا تشبيه بأعين المخلوقين", keywords: ["أعين", "صفات", "إثبات"] },
  { topic: "العقيدة", title: "إثبات القدم لله", content: "لله قدم يضعها في جهنم يوم القيامة فتقول \"قَطٌّ قَطٌّ\" وتنزوي", keywords: ["قدم", "صفات", "إثبات"] },
  { topic: "العقيدة", title: "إثبات الأصابع لله", content: "لله أصابع حقيقية كما في الحديث، والقلوب بين إصبعين منها يقلبها كيف يشاء", keywords: ["أصابع", "صفات", "تقليب القلوب"] },
  { topic: "العقيدة", title: "نزول الرب سبحانه", content: "ينزل الله إلى السماء الدنيا كل ليلة كما أخبر الرسول عليه الصلاة والسلام", keywords: ["نزول", "ليل", "السماء الدنيا"] },
  ...
  { topic: "فقه: الصيام", title: "الشيخ الكبير والعجوز العاجزان", content: "الشيخ الكبير والعجوز العاجزان عن الصوم لهما أن يفطرا، ويستحب لهما إطعام مسكين عن كل يوم مداً من حنطة", keywords: ["الشيخ", "الكبير", "يفطرا"] },
...
const ISLAMIC_QUESTION_BANK = {
  ...
  { q: "ماذا يقول أهل العلم عن \"إثبات اليدين لله\" في باب العقيدة؟", o: ["لا أصل له في الشريعة الإسلامية", "من البدع المحدثة في الدين", "اختلف فيه السلف ولم يُحسم الخلاف", "لله يدان حقيقتان كما يليق بجلاله، {بَلْ يَدَاهُ مَبْسُوطَتَانِ}"], a: 3, topic: "العقيدة", explanation: "لله يدان حقيقتان كما يليق بجلاله، {بَلْ يَدَاهُ مَبْسُوطَتَانِ}" },
  { q: "ماذا يقول أهل العلم عن \"إثبات الوجه لله\" في باب العقيدة؟", o: ["لله وجه موصوف بالجلال والإكرام ليس كمثله شيء", "لا أصل له في الشريعة الإسلامية", "من البدع المحدثة في الدين", "اختلف فيه السلف ولم يُحسم الخلاف"], a: 0, topic: "العقيدة", explanation: "لله وجه موصوف بالجلال والإكرام ليس كمثله شيء" },
  { q: "ماذا يقول أهل العلم عن \"إثبات العينين لله\" في باب العقيدة؟", o: ["لا أصل له في الشريعة الإسلامية", "لله عينان تليقان بجلاله، {تَجْرِي بِأَعْيُنِنَا} بلا تشبيه بأعين المخلوقين", "من البدع المحدثة في الدين", "اختلف فيه السلف ولم يُحسم الخلاف"], a: 1, topic: "العقيدة", explanation: "لله عينان تليقان بجلاله، {تَجْرِي بِأَعْيُنِنَا} بلا تشبيه بأعين المخلوقين" },
  { q: "ماذا يقول أهل العلم عن \"إثبات القدم لله\" في باب العقيدة؟", o: ["لله قدم يضعها في جهنم يوم القيامة فتقول \"قَطٌّ قَطٌّ\" وتنزوي", "لا أصل له في الشريعة الإسلامية", "من البدع المحدثة في الدين", "اختلف فيه السلف ولم يُحسم الخلاف"], a: 0, topic: "العقيدة", explanation: "لله قدم يضعها في جهنم يوم القيامة فتقول \\\"قَطٌّ قَطٌّ\\\" وتنزوي" },
  { q: "ماذا يقول أهل العلم عن \"إثبات الأصابع لله\" في باب العقيدة؟", o: ["لله أصابع حقيقية كما في الحديث، والقلوب بين إصبعين منها يقلبها كيف يشاء", "لا أصل له في الشريعة الإسلامية", "من البدع المحدثة في الدين", "اختلف فيه السلف ولم يُحسم الخلاف"], a: 0, topic: "العقيدة", explanation: "لله أصابع حقيقية كما في الحديث، والقلوب بين إصبعين منها يقلبها كيف يشاء" },
  { q: "ماذا يقول أهل العلم عن \"نزول الرب سبحانه\" في باب العقيدة؟", o: ["لا أصل له في الشريعة الإسلامية", "من البدع المحدثة في الدين", "ينزل الله إلى السماء الدنيا كل ليلة كما أخبر الرسول عليه الصلاة والسلام", "اختلف فيه السلف ولم يُحسم الخلاف"], a: 2, topic: "العقيدة", explanation: "ينزل الله إلى السماء الدنيا كل ليلة كما أخبر الرسول عليه الصلاة والسلام" },
...
/* ====== دالة موحدة لاستدعاء OpenRouter API مع دعم النموذج الاحتياطي ======
   تجرب النموذج الأساسي (ultra — جودة عالية) أولاً، وفي حال الفشل
   تنتقل للنموذج الاحتياطي (super — متوفر دائماً).
   النماذج المجانية لا تحتاج مفاتيح احتياطية.
...
const AI_MODELS = [
  { id: "nvidia/nemotron-3-ultra-550b-a55b:free", label: "Ultra (جودة عالية)" },
  { id: "nvidia/nemotron-3-super-120b-a12b:free", label: "Super (متوفر دائماً)" },
];

async function callOpenRouterWithFallback({ body, signal, referer, title }) {
  // نستخدم مفتاح API واحد (لا حاجة لمفتاح احتياطي مع نماذج مجانية)
  ...
  for (let i = 0; i < AI_MODELS.length; i++) {
    ...
    try {
      // استبدل النموذج في body مع الإبقاء على بقية المعاملات
      const bodyWithModel = { ...body, model: model.id };
      ...
      const res = await fetch("https://openrouter.ai/api/v1/chat/completions", {
        ...
        headers: {
          ...
          "HTTP-Referer": referer || "https://who-wants-to-be-a-millionaire.local",
          "X-Title": title || "Arabic Millionaire Game",
        },
      ...
      // ⚠️ فحص حاسم: OpenRouter قد يُرجع HTTP 200 مع كائن خطأ في الجسم
      if (data.error) {
...
async function fetchQuestionFromAI(index, total) {
  ...
  try {
    const { data } = await callOpenRouterWithFallback({
      body: {
        // النموذج يُحدد تلقائياً داخل callOpenRouterWithFallback (ultra → super)
        messages: [
...
function renderQuestion() {
  ...
  if (card) {
    card.classList.remove("source-ai", "source-bank", "source-ai-islamic", "source-islamic-bank");

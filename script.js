...
function handleBattleEnd(data) {
  ...
  if (activeCount === 1 && battleState.players[battleState.myIndex] && battleState.players[battleState.myIndex].active) {
    // أنا اللاعب الوحيد المتبقي — فزت بالتخلف
    icon = "🏆";
    title = "فزت بالتخلف!";
    subtitle = "غادر بقية اللاعبين المعركة.";

...
const LOY_BANK = [
  // ===== مضحكة (25) =====
  { o: ["أن تأكل بيتزا كل يوم لبقية حياتك", "ألا تأكل بيتزا أبداً"], s: [55, 45], t: "طعام", m: "مضحك" },
  { o: ["أن تنام بجانب دب", "أن تنام بجانب تمساح"], s: [62, 38], t: "حيوانات", m: "مضحك" },
  { o: ["أن يكون لديك ذيل", "أن يكون لديك قرون"], s: [70, 30], t: "خيال", m: "مضحك" },
  { o: ["أن تعطس 100 مرة متتالية", "أن تتثاءب 100 مرة متتالية"], s: [48, 52], t: "جسد", m: "مضحك" },
  { o: ["أن تشم رائحة كريهة طوال اليوم", "أن تسمع صوتاً مزعجاً طوال اليوم"], s: [40, 60], t: "حواس", m: "مضحك" },
  { o: ["أن تنسى اسمك دائماً", "أن تنسى وجهك في المرآة"], s: [58, 42], t: "هوية", m: "مضحك" },
  { o: ["أن يتحدث كلبك", "أن يتحدث قطك"], s: [60, 40], t: "حيوانات", m: "مضحك" },
  { o: ["أن تأكل طعامك المفضل بلا توقف ولا تشبع أبداً", "أن تشبع بمجرد رؤية الطعام"], s: [35, 65], t: "طعام", m: "مضحك" },
  { o: ["أن تستحم بماء بارد كل يوم", "ألا تستحم أبداً"], s: [78, 22], t: "نظافة", m: "مضحك" },
  { o: ["أن ترتدي ملابس مقلوبة طوال اليوم", "أن ترتدي حذاءً بمقاس أكبر بمرتين"], s: [67, 33], t: "مظهر", m: "مضحك" },
  { o: ["أن تضحك في جنازة", "أن تبكي في حفل زفاف"], s: [44, 56], t: "مواقف", m: "مضحك" },
  { o: ["أن تكون السلحفاة الأبطأ", "أن تكون الأرنب الأشطر"], s: [38, 62], t: "خيال", m: "مضحك" },
  { o: ["أن تأكل دجاجاً بكل وجبة", "أن تأكل سمكاً بكل وجبة"], s: [65, 35], t: "طعام", m: "مضحك" },
  { o: ["أن تعيش بدون هاتف", "أن تعيش بدون مرآة"], s: [50, 50], t: "حياة", m: "مضحك" },
  { o: ["أن تتحدث بسرعة فائقة", "أن تتحدث ببطء شديد"], s: [55, 45], t: "تواصل", m: "مضحك" },
  { o: ["أن يكون بصرك حاداً كالصقر", "أن يكون سمعك دقيقاً كالخفاش"], s: [70, 30], t: "حواس", m: "مضحك" },
  { o: ["أن تذهب للعمل ببيجاما", "أن تذهب للعمل بحذاء رياضي فقط"], s: [60, 40], t: "مواقف", m: "مضحك" },
  { o: ["أن تسمع نكتة سيئة 100 مرة", "أن تسمع قصة حزينة مرة واحدة"], s: [57, 43], t: "مشاعر", m: "مضحك" },
  { o: ["أن تشرب عصير ليمون حامض بدون سكر", "أن تشرب كوب زيت زيتون"], s: [75, 25], t: "طعام", m: "مضحك" },
  { o: ["أن يكون اسمك 'بيبة'", "أن يكون اسمك 'شحفوف'"], s: [42, 58], t: "هوية", m: "مضحك" },
  { o: ["أن يكون لك شارب كث", "أن يكون لك لحية طويلة جداً"], s: [50, 50], t: "مظهر", m: "مضحك" },
  { o: ["أن تحلم كل ليلة بالعمل", "ألا تنام أبداً"], s: [33, 67], t: "نوم", m: "مضحك" },
  { o: ["أن يكون رأسك كبيراً جداً", "أن يكون رأسك صغيراً جداً"], s: [55, 45], t: "مظهر", m: "مضحك" },
  { o: ["أن تتحدث بلغة لا يفهمها أحد", "أن تفهم كل اللغات دون القدرة على التحدث"], s: [40, 60], t: "تواصل", m: "مضحك" },
  { o: ["أن تعيش بدون إنترنت", "أن تعيش بدون هاتف"], s: [50, 50], t: "حياة", m: "مضحك" },

  // ===== غريبة (25) =====
  { o: ["أن تعيش في كهف تحت الأرض", "أن تعيش في منزل عائم على الماء"], s: [35, 65], t: "سكن", m: "غريب" },
  { o: ["أن تمتلك أذناً ثالثة", "أن تمتلك عيناً ثالثة"], s: [30, 70], t: "جسد", m: "غريب" },
  { o: ["أن تسافر عبر الزمن للماضي", "أن تسافر عبر الزمن للمستقبل"], s: [55, 45], t: "خيال", m: "غريب" },
  { o: ["أن تعيش على كوكب أحمر بلا نباتات", "أن تعيش على كوكب أخضر بلا ماء"], s: [42, 58], t: "فضاء", m: "غريب" },
  { o: ["أن تتحدث مع الحيوانات", "أن تقرأ الأفكار"], s: [60, 40], t: "قدرات", m: "غريب" },
  { o: ["أن تنام لمدة سنة كاملة", "أن تبقى مستيقظاً شهراً كاملاً"], s: [38, 62], t: "نوم", m: "غريب" },
  { o: ["أن تمتلك أجنحة تحلّق بها", "أن تمتلك خياشيم تتنفس بها تحت الماء"], s: [68, 32], t: "قدرات", m: "غريب" },
  { o: ["أن تكون ذكياً جداً بلا مشاعر", "أن تكون عاطفياً جداً بلا منطق"], s: [50, 50], t: "شخصية", m: "غريب" },
  { o: ["أن ترى الأشباح", "أن تسمع أصوات الموتى"], s: [45, 55], t: "خوارق", m: "غريب" },
  { o: ["أن يكون جلدك أزرق", "أن تكون عيناك صفراوين"], s: [40, 60], t: "مظهر", m: "غريب" },
  { o: ["أن تعيش في عالم من الحلوى", "أن تعيش في عالم من الألعاب"], s: [45, 55], t: "خيال", m: "غريب" },
  { o: ["أن تمتلك قدرة التخفي", "أن تمتلك القدرة على الانتقال الفوري"], s: [40, 60], t: "قدرات", m: "غريب" },
  { o: ["أن تعيش حياتك مرة أخرى من البداية", "أن تبدأ حياة جديدة كلياً"], s: [50, 50], t: "حياة", m: "غريب" },
  { o: ["أن تمتلك قوة العنكبوت", "أن تمتلك سرعة الفهد"], s: [48, 52], t: "قدرات", m: "غريب" },
  { o: ["أن تعيش في قلعة قديمة", "أن تعيش في منزل مستقبلي ذكي"], s: [38, 62], t: "سكن", m: "غريب" },
  { o: ["أن تكون آخر إنسان على الأرض", "أن تكون أول إنسان على المريخ"], s: [35, 65], t: "فضاء", m: "غريب" },
  { o: ["أن تتحدث بلغة قديمة منقرضة", "أن تتحدث بلغة مستقبلية لم تُخترع بعد"], s: [55, 45], t: "لغات", m: "غريب" },
  { o: ["أن تتحكم بالطقس", "أن تتحكم بالوقت"], s: [30, 70], t: "قدرات", m: "غريب" },
  { o: ["أن تمتلك يداً ثالثة", "أن تمتلك عيناً خلف رأسك"], s: [60, 40], t: "جسد", m: "غريب" },
  { o: ["أن تعيش في عالم بلا موسيقى", "أن تعيش في عالم بلا ألوان"], s: [55, 45], t: "فنون", m: "غريب" },
  { o: ["أن تتنقل بآلة زمن", "أن تتنقل ببوابة انتقال فوري"], s: [50, 50], t: "خيال", m: "غريب" },
  { o: ["أن تمتلك شجرة تنبت نقوداً", "أن تمتلك نهراً يجري عسلاً"], s: [65, 35], t: "خيال", m: "غريب" },
  { o: ["أن تعيش بلا أحلام", "أن تحلم أحلاماً كابوسية كل ليلة"], s: [70, 30], t: "نوم", m: "غريب" },
  { o: ["أن تمتلك ذاكرة فوتوغرافية", "أن تنسى أي شيء تريد"], s: [60, 40], t: "عقل", m: "غريب" },
  { o: ["أن يصبح ظلك شخصاً آخر", "أن تنعكس صورتك في المرآة بشكل مختلف"], s: [45, 55], t: "خوارق", m: "غريب" },

  // ===== صعبة (25) =====
  { o: ["أن تنقذ 5 غرباء", "أن تنقذ شخصاً تحبه"], s: [40, 60], t: "أخلاق", m: "صعب" },
  { o: ["أن تعرف الحقيقة المطلقة المؤلمة", "أن تعيش بكذبة مريحة"], s: [55, 45], t: "أخلاق", m: "صعب" },
  { o: ["أن تموت شاباً سعيداً", "أن تعيش كبيراً حزيناً"], s: [60, 40], t: "حياة", m: "صعب" },
  { o: ["أن تنقذ نفسك", "أن تنقذ غريباً بريئاً"], s: [50, 50], t: "أخلاق", m: "صعب" },
  { o: ["أن تعرف موعد وفاتك", "أن تعرف سبب وفاتك"], s: [35, 65], t: "حياة", m: "صعب" },
  { o: ["أن تنسى أسوأ ذكرياتك", "أن تنسى أفضل ذكرياتك"], s: [70, 30], t: "عقل", m: "صعب" },
  { o: ["أن تعيش بلا ألم جسدي", "أن تعيش بلا ألم نفسي"], s: [40, 60], t: "مشاعر", m: "صعب" },
  { o: ["أن تخسر كل أموالك", "أن تخسر كل أصدقائك"], s: [55, 45], t: "حياة", m: "صعب" },
  { o: ["أن تكون مشهوراً يكرهك الناس", "أن تكون مجهولاً يحبك المقربون"], s: [25, 75], t: "شهرة", m: "صعب" },
  { o: ["أن تقتل شخصاً لإنقاذ ألف", "أن تترك الألف يموتون"], s: [60, 40], t: "أخلاق", m: "صعب" },
  { o: ["أن تعيش بلا حب", "أن تعيش بلا صداقة"], s: [40, 60], t: "مشاعر", m: "صعب" },
  { o: ["أن يكون لديك وقت كبير بلا مال", "أن يكون لديك مال كبير بلا وقت"], s: [55, 45], t: "حياة", m: "صعب" },
  { o: ["أن تعرف كل شيء", "ألا تعرف شيئاً"], s: [70, 30], t: "عقل", m: "صعب" },
  { o: ["أن تكون قوياً بلا حكمة", "أن تكون حكيماً بلا قوة"], s: [35, 65], t: "شخصية", m: "صعب" },
  { o: ["أن تعيش حياة واحدة طويلة", "أن تعيش عدة حيوات قصيرة"], s: [60, 40], t: "حياة", m: "صعب" },
  { o: ["أن تُحرم من النوم ليومين", "أن تُحرم من الطعام ليومين"], s: [40, 60], t: "جسد", m: "صعب" },
  { o: ["أن تخسر بصرك", "أن تخسر سمعك"], s: [40, 60], t: "حواس", m: "صعب" },
  { o: ["أن تعيش بلا ماضٍ", "أن تعيش بلا مستقبل"], s: [50, 50], t: "حياة", m: "صعب" },
  { o: ["أن تكون ثرياً وحيداً", "أن تكون فقيراً محاطاً بالعائلة"], s: [25, 75], t: "حياة", m: "صعب" },
  { o: ["أن تُسجن بريئاً 10 سنوات", "أن تُعاقب علناً على ذنب لم ترتكبه"], s: [45, 55], t: "عدل", m: "صعب" },
  { o: ["أن تعرف سر الكون", "أن تعيش سعيداً بلا معرفة"], s: [50, 50], t: "فلسفي", m: "صعب" },
  { o: ["أن تخوض حرباً لا تؤمن بها", "أن تهرب من وطنك"], s: [40, 60], t: "أخلاق", m: "صعب" },
  { o: ["أن تُنسى بعد موتك", "أن تُذكر بأفعال سيئة"], s: [60, 40], t: "إرث", m: "صعب" },
  { o: ["أن تختار لمن تعطي حياتك", "أن يختار الطبيب عشوائياً"], s: [70, 30], t: "أخلاق", m: "صعب" },
  { o: ["أن تخون صديقاً", "أن تخون وطنك"], s: [55, 45], t: "أخلاق", m: "صعب" },

  // ===== فلسفية (25) =====
  { o: ["أن تكون حراً بلا هدف", "أن تكون مقيداً بهدف نبيل"], s: [45, 55], t: "فلسفي", m: "فلسفي" },
  { o: ["أن تمتلك المال", "أن تمتلك الشهرة"], s: [70, 30], t: "حياة", m: "فلسفي" },
  { o: ["أن تعرف الحب", "أن تعرف الحكمة"], s: [60, 40], t: "فلسفي", m: "فلسفي" },
  { o: ["أن تمتلك القوة", "أن تمتلك اللطف"], s: [35, 65], t: "فلسفي", m: "فلسفي" },
  { o: ["أن تكون محقاً وحيداً", "أن تكون مخطئاً مع الجماعة"], s: [55, 45], t: "فلسفي", m: "فلسفي" },
  { o: ["أن تحقق السلام العالمي", "أن تنهي الفقر"], s: [50, 50], t: "أخلاق", m: "فلسفي" },
  { o: ["أن تعرف المعرفة المطلقة", "أن تعرف السعادة المطلقة"], s: [45, 55], t: "فلسفي", m: "فلسفي" },
  { o: ["أن يخلد جسدك", "أن تخلد روحك"], s: [25, 75], t: "فلسفي", m: "فلسفي" },
  { o: ["أن تعيش في الحاضر دائماً", "أن تتأمل الماضي والمستقبل"], s: [60, 40], t: "فلسفي", m: "فلسفي" },
  { o: ["أن يكون لك جمال داخلي", "أن يكون لك جمال خارجي"], s: [80, 20], t: "قيم", m: "فلسفي" },
  { o: ["أن تنجح بصعوبة", "أن تفشل بسهولة"], s: [85, 15], t: "حياة", m: "فلسفي" },
  { o: ["أن تعيش كفرد", "أن تعيش كجزء من جماعة"], s: [40, 60], t: "مجتمع", m: "فلسفي" },
  { o: ["أن تتبع قلبك", "أن تتبع عقلك"], s: [55, 45], t: "فلسفي", m: "فلسفي" },
  { o: ["أن تعيش حياة بسيطة هادئة", "أن تعيش حياة مليئة بالمغامرات الخطيرة"], s: [50, 50], t: "حياة", m: "فلسفي" },
  { o: ["أن يكون لك أثر كبير بعد موتك", "أن تعيش طويلاً بلا أثر"], s: [60, 40], t: "إرث", m: "فلسفي" },
  { o: ["أن تختار العدالة", "أن تختار الرحمة"], s: [45, 55], t: "قيم", m: "فلسفي" },
  { o: ["أن تصل للكمال", "أن تتطور باستمرار"], s: [30, 70], t: "فلسفي", m: "فلسفي" },
  { o: ["أن تحب الفن", "أن تحب العلم"], s: [40, 60], t: "معرفة", m: "فلسفي" },
  { o: ["أن تكون محبوباً", "أن تحب"], s: [50, 50], t: "مشاعر", m: "فلسفي" },
  { o: ["أن تعيش بحرية", "أن تعيش بأمان"], s: [55, 45], t: "مجتمع", m: "فلسفي" },
  { o: ["أن تعرف الحقيقة", "أن تعرف السعادة"], s: [50, 50], t: "فلسفي", m: "فلسفي" },
  { o: ["أن تكون عقلانياً", "أن تكون عاطفياً"], s: [50, 50], t: "فلسفي", m: "فلسفي" },
  { o: ["أن تكون منظماً", "أن تكون عفوياً"], s: [55, 45], t: "شخصية", m: "فلسفي" },
  { o: ["أن تحلم بحياة أفضل", "أن تقبل بحياتك كما هي"], s: [65, 35], t: "فلسفي", m: "فلسفي" },
  { o: ["أن تكون منظّراً عظيماً", "أن تكون منفّذاً عادياً"], s: [40, 60], t: "حياة", m: "فلسفي" },
];
...
async function loadLoyQuestion() {
  loyState.answered = false;
  loyState.selectedOption = null;
  loyState.optionsRevealed = true; // الخيارات تظهر مباشرة (لا زر "أجب الآن")
  document.getElementById("loy-reveal-panel").style.display = "none";
  document.getElementById("loy-actions").style.display = "none";

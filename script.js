...
/* ====== بنك أسئلة لو خيروك المدمج (100 سؤال متنوع) ======
   كل سؤال يحوي: prompt (نص يبدأ بـ "لو خيروك بين...")، options (2-4 خيارات)،
...
const LOY_BANK = [
  // ===== مضحكة (25) =====
  { p: "لو خيروك بين قول الحقيقة دائماً أو الكذب دائماً؟", o: ["قول الحقيقة دائماً", "الكذب دائماً"], s: [72, 28], t: "أخلاق", m: "صعب" },
  { p: "لو خيروك بين أكل بيتزا كل يوم لبقية حياتك أو عدم أكلها أبداً؟", o: ["بيتزا كل يوم", "لا بيتزا أبداً"], s: [55, 45], t: "طعام", m: "مضحك" },
  { p: "لو خيروك بين النوم بجانب دب أو بجانب تمساح؟", o: ["الدب", "التمساح"], s: [62, 38], t: "حيوانات", m: "مضحك" },
  { p: "لو خيروك بين أن يكون لديك ذيل أو قرون؟", o: ["ذيل", "قرون"], s: [70, 30], t: "خيال", m: "مضحك" },
  { p: "لو خيروك بين العطس 100 مرة متتالية أو التثاؤب 100 مرة متتالية؟", o: ["العطس 100 مرة", "التثاؤب 100 مرة"], s: [48, 52], t: "جسد", m: "مضحك" },
  { p: "لو خيروك بين شم رائحة كريهة طوال اليوم أو سماع صوت مزعج طوال اليوم؟", o: ["رائحة كريهة", "صوت مزعج"], s: [40, 60], t: "حواس", m: "مضحك" },
  { p: "لو خيروك بين نسيان اسمك دائماً أو نسيان وجهك في المرآة؟", o: ["نسيان اسمي", "نسيان وجهي"], s: [58, 42], t: "هوية", m: "مضحك" },
  { p: "لو خيروك بين أن يتحدث كلبك أو أن يتحدث قطك؟", o: ["الكلب يتحدث", "القط يتحدث"], s: [60, 40], t: "حيوانات", m: "مضحك" },
  { p: "لو خيروك بين أكل طعامك المفضل بلا توقف ولا تشبع أبداً أو الشبع بمجرد رؤية الطعام؟", o: ["أكل بلا شبع", "الشبع بمجرد الرؤية"], s: [35, 65], t: "طعام", m: "مضحك" },
  { p: "لو خيروك بين الاستحمام بماء بارد كل يوم أو عدم الاستحمام أبداً؟", o: ["ماء بارد يومياً", "لا استحمام أبداً"], s: [78, 22], t: "نظافة", m: "مضحك" },
  { p: "لو خيروك بين ارتداء ملابس مقلوبة طوال اليوم أو ارتداء حذاء بمقاس أكبر بمرتين؟", o: ["ملابس مقلوبة", "حذاء ضخم"], s: [67, 33], t: "مظهر", m: "مضحك" },
  { p: "لو خيروك بين الضحك في جنازة أو البكاء في حفل زفاف؟", o: ["الضحك في جنازة", "البكاء في حفل زفاف"], s: [44, 56], t: "مواقف", m: "مضحك" },
  { p: "لو خيروك بين أن تكون السلحفاة الأبطأ أو الأرنب الأشطر؟", o: ["السلحفاة الأبطأ", "الأرنب الأشطر"], s: [38, 62], t: "خيال", m: "مضحك" },
  { p: "لو خيروك بين أكل دجاج بكل وجبة أو أكل سمك بكل وجبة؟", o: ["دجاج دائماً", "سمك دائماً"], s: [65, 35], t: "طعام", m: "مضحك" },
  { p: "لو خيروك بين أن تعيش بدون هاتف أو بدون مرآة؟", o: ["بدون هاتف", "بدون مرآة"], s: [50, 50], t: "حياة", m: "مضحك" },
  { p: "لو خيروك بين التحدث بسرعة فائقة أو ببطء شديد؟", o: ["بسرعة فائقة", "ببطء شديد"], s: [55, 45], t: "تواصل", m: "مضحك" },
  { p: "لو خيروك بين أن يكون بصرك حاداً كالصقر أو سمعك دقيقاً كالخفاش؟", o: ["بصر كالصقر", "سمع كالخفاش"], s: [70, 30], t: "حواس", m: "مضحك" },
  { p: "لو خيروك بين الذهاب للعمل ببيجاما أو بحذاء رياضي فقط؟", o: ["بيجاما", "حذاء رياضي فقط"], s: [60, 40], t: "مواقف", m: "مضحك" },
  { p: "لو خيروك بين سماع نكتة سيئة 100 مرة أو سماع قصة حزينة مرة واحدة؟", o: ["النكتة السيئة 100 مرة", "القصة الحزينة مرة واحدة"], s: [57, 43], t: "مشاعر", m: "مضحك" },
  { p: "لو خيروك بين شرب عصير ليمون حامض بدون سكر أو شرب كوب زيت زيتون؟", o: ["عصير ليمون حامض", "كوب زيت زيتون"], s: [75, 25], t: "طعام", m: "مضحك" },
  { p: "لو خيروك بين أن يكون اسمك 'بيبة' أو 'شحفوف'؟", o: ["بيبة", "شحفوف"], s: [42, 58], t: "هوية", m: "مضحك" },
  { p: "لو خيروك بين الحصول على شارب كث أو لحية طويلة جداً (للرجال والنساء)؟", o: ["شارب كث", "لحية طويلة"], s: [50, 50], t: "مظهر", m: "مضحك" },
  { p: "لو خيروك بين أن تحلم كل ليلة بالعمل أو ألا تنام أبداً؟", o: ["أحلام بالعمل", "لا نوم أبداً"], s: [33, 67], t: "نوم", m: "مضحك" },
  { p: "لو خيروك بين أن يكون رأسك كبيراً جداً أو صغيراً جداً؟", o: ["رأس كبير جداً", "رأس صغير جداً"], s: [55, 45], t: "مظهر", m: "مضحك" },
  { p: "لو خيروك بين التحدث بلغة لا يفهمها أحد أو فهم كل اللغات دون القدرة على التحدث؟", o: ["لغة لا تُفهم", "فهم بلا كلام"], s: [40, 60], t: "تواصل", m: "مضحك" },

  // ===== غريبة (25) =====
  { p: "لو خيروك بين العيش في كهف تحت الأرض أو في منزل عائم على الماء؟", o: ["كهف تحت الأرض", "منزل عائم"], s: [35, 65], t: "سكن", m: "غريب" },
  { p: "لو خيروك بين امتلاك أذن ثالثة أو عين ثالثة؟", o: ["أذن ثالثة", "عين ثالثة"], s: [30, 70], t: "جسد", m: "غريب" },
  { p: "لو خيروك بين السفر عبر الزمن للماضي أو للمستقبل؟", o: ["الماضي", "المستقبل"], s: [55, 45], t: "خيال", m: "غريب" },
  { p: "لو خيروك بين العيش على كوكب أحمر بلا نباتات أو على كوكب أخضر بلا ماء؟", o: ["كوكب أحمر بلا نباتات", "كوكب أخضر بلا ماء"], s: [42, 58], t: "فضاء", m: "غريب" },
  { p: "لو خيروك بين التحدث مع الحيوانات أو قراءة الأفكار؟", o: ["التحدث مع الحيوانات", "قراءة الأفكار"], s: [60, 40], t: "قدرات", m: "غريب" },
  { p: "لو خيروك بين النوم لمدة سنة كاملة أو البقاء مستيقظاً شهراً كاملاً؟", o: ["النوم سنة", "اليقظة شهر"], s: [38, 62], t: "نوم", m: "غريب" },
  { p: "لو خيروك بين امتلاك أجنحة تحلّق بها أو خياشيم تتنفس بها تحت الماء؟", o: ["أجنحة للطيران", "خياشيم للغوص"], s: [68, 32], t: "قدرات", m: "غريب" },
  { p: "لو خيروك بين أن تكون ذكياً جداً بلا مشاعر أو عاطفياً جداً بلا منطق؟", o: ["ذكي بلا مشاعر", "عاطفي بلا منطق"], s: [50, 50], t: "شخصية", m: "غريب" },
  { p: "لو خيروك بين رؤية الأشباح أو سماع أصوات الموتى؟", o: ["رؤية الأشباح", "سماع الأصوات"], s: [45, 55], t: "خوارق", m: "غريب" },
  { p: "لو خيروك بين أن يكون جلدك أزرق أو عينيك صفراوين؟", o: ["جلد أزرق", "عينان صفراوان"], s: [40, 60], t: "مظهر", m: "غريب" },
  { p: "لو خيروك بين العيش في عالم من الحلوى أو عالم من الألعاب؟", o: ["عالم الحلوى", "عالم الألعاب"], s: [45, 55], t: "خيال", m: "غريب" },
  { p: "لو خيروك بين امتلاك قدرة التخفي أو القدرة على الانتقال الفوري؟", o: ["التخفي", "الانتقال الفوري"], s: [40, 60], t: "قدرات", m: "غريب" },
  { p: "لو خيروك بين أن تعيش حياتك مرة أخرى من البداية أو تبدأ حياة جديدة كلياً؟", o: ["إعادة حياتي", "حياة جديدة"], s: [50, 50], t: "حياة", m: "غريب" },
  { p: "لو خيروك بين امتلاك قوة العنكبوت أو سرعة الفهد؟", o: ["قوة العنكبوت", "سرعة الفهد"], s: [48, 52], t: "قدرات", m: "غريب" },
  { p: "لو خيروك بين الحياة في قلعة قديمة أو في منزل مستقبلي ذكي؟", o: ["قلعة قديمة", "منزل مستقبلي"], s: [38, 62], t: "سكن", m: "غريب" },
  { p: "لو خيروك بين أن تكون آخر إنسان على الأرض أو أول إنسان على المريخ؟", o: ["آخر إنسان بالأرض", "أول إنسان بالمريخ"], s: [35, 65], t: "فضاء", m: "غريب" },
  { p: "لو خيروك بين التحدث بلغة قديمة منقرضة أو لغة مستقبلية لم تُخترع بعد؟", o: ["لغة قديمة", "لغة مستقبلية"], s: [55, 45], t: "لغات", m: "غريب" },
  { p: "لو خيروك بين التحكم بالطقس أو التحكم بالوقت؟", o: ["التحكم بالطقس", "التحكم بالوقت"], s: [30, 70], t: "قدرات", m: "غريب" },
  { p: "لو خيروك بين امتلاك يد ثالثة أو عين خلف رأسك؟", o: ["يد ثالثة", "عين خلف الرأس"], s: [60, 40], t: "جسد", m: "غريب" },
  { p: "لو خيروك بين أن تعيش في عالم بلا موسيقى أو بلا ألوان؟", o: ["بلا موسيقى", "بلا ألوان"], s: [55, 45], t: "فنون", m: "غريب" },
  { p: "لو خيروك بين التنقل بآلة زمن أو ببوابة انتقال فوري؟", o: ["آلة زمن", "بوابة انتقال"], s: [50, 50], t: "خيال", m: "غريب" },
  { p: "لو خيروك بين امتلاك شجرة تنبت نقوداً أو نهر يجري عسلاً؟", o: ["شجرة النقود", "نهر العسل"], s: [65, 35], t: "خيال", m: "غريب" },
  { p: "لو خيروك بين الحياة بلا أحلام أو الأحلام الكابوسية كل ليلة؟", o: ["بلا أحلام", "كوابيس كل ليلة"], s: [70, 30], t: "نوم", m: "غريب" },
  { p: "لو خيروك بين امتلاك ذاكرة فوتوغرافية أو القدرة على نسيان أي شيء تريد؟", o: ["ذاكرة فوتوغرافية", "نسيان ما تريد"], s: [60, 40], t: "عقل", m: "غريب" },
  { p: "لو خيروك بين أن يصبح ظلك شخصاً آخر أو أن تنعكس صورتك في المرآة بشكل مختلف؟", o: ["ظل آخر", "انعكاس مختلف"], s: [45, 55], t: "خوارق", m: "غريب" },

  // ===== صعبة (25) =====
  { p: "لو خيروك بين إنقاذ 5 غرباء أو شخص تحبه؟", o: ["5 غرباء", "شخص تحبه"], s: [40, 60], t: "أخلاق", m: "صعب" },
  { p: "لو خيروك بين الحقيقة المطلقة المؤلمة أو الكذبة المريحة؟", o: ["الحقيقة المؤلمة", "الكذبة المريحة"], s: [55, 45], t: "أخلاق", m: "صعب" },
  { p: "لو خيروك بين أن تموت شاباً سعيداً أو كبيراً حزيناً؟", o: ["شاب سعيد", "كبير حزين"], s: [60, 40], t: "حياة", m: "صعب" },
  { p: "لو خيروك بين إنقاذ نفسك أو إنقاذ غريب بريء؟", o: ["إنقاذ نفسي", "إنقاذ الغريب"], s: [50, 50], t: "أخلاق", m: "صعب" },
  { p: "لو خيروك بين أن تعرف موعد وفاتك أو سبب وفاتك؟", o: ["موعد الوفاة", "سبب الوفاة"], s: [35, 65], t: "حياة", m: "صعب" },
  { p: "لو خيروك بين أن تنسى أسوأ ذكرياتك أو أفضل ذكرياتك؟", o: ["أسوأ الذكريات", "أفضل الذكريات"], s: [70, 30], t: "عقل", m: "صعب" },
  { p: "لو خيروك بين العيش بلا ألم جسدي أو بلا ألم نفسي؟", o: ["بلا ألم جسدي", "بلا ألم نفسي"], s: [40, 60], t: "مشاعر", m: "صعب" },
  { p: "لو خيروك بين أن تخسر كل أموالك أو كل أصدقائك؟", o: ["كل الأموال", "كل الأصدقاء"], s: [55, 45], t: "حياة", m: "صعب" },
  { p: "لو خيروك بين أن تكون مشهوراً يكرهك الناس أو مجهولاً يحبك المقربون؟", o: ["مشهور مكروه", "مجهول محبوب"], s: [25, 75], t: "شهرة", m: "صعب" },
  { p: "لو خيروك بين قتل شخص لإنقاذ ألف شخص أو ترك الألف يموتون؟", o: ["قتل واحد لإنقاذ ألف", "ترك الألف يموتون"], s: [60, 40], t: "أخلاق", m: "صعب" },
  { p: "لو خيروك بين العيش بلا حب أو بلا صداقة؟", o: ["بلا حب", "بلا صداقة"], s: [40, 60], t: "مشاعر", m: "صعب" },
  { p: "لو خيروك بين أن يكون لديك وقت كبير بلا مال أو مال كبير بلا وقت؟", o: ["وقت بلا مال", "مال بلا وقت"], s: [55, 45], t: "حياة", m: "صعب" },
  { p: "لو خيروك بين أن تعرف كل شيء أو لا تعرف شيئاً؟", o: ["معرفة كل شيء", "لا معرفة"], s: [70, 30], t: "عقل", m: "صعب" },
  { p: "لو خيروك بين أن تكون قوياً بلا حكمة أو حكيماً بلا قوة؟", o: ["قوي بلا حكمة", "حكيم بلا قوة"], s: [35, 65], t: "شخصية", m: "صعب" },
  { p: "لو خيروك بين أن تعيش حياة واحدة طويلة أو عدة حيوات قصيرة؟", o: ["حياة واحدة طويلة", "حيوات قصيرة متعددة"], s: [60, 40], t: "حياة", m: "صعب" },
  { p: "لو خيروك بين الحرمان من النوم أو الحرمان من الطعام ليومين؟", o: ["بلا نوم", "بلا طعام"], s: [40, 60], t: "جسد", m: "صعب" },
  { p: "لو خيروك بين خيانة صديق أو خيانة وطن؟", o: ["خيانة صديق", "خيانة وطن"], s: [55, 45], t: "أخلاق", m: "صعب" },
  { p: "لو خيروك بين أن تخسر بصرك أو سمعك؟", o: ["خسارة البصر", "خسارة السمع"], s: [40, 60], t: "حواس", m: "صعب" },
  { p: "لو خيروك بين العيش بلا ماضٍ أو بلا مستقبل؟", o: ["بلا ماضٍ", "بلا مستقبل"], s: [50, 50], t: "حياة", m: "صعب" },
  { p: "لو خيروك بين أن تكون ثرياً وحيداً أو فقيراً محاطاً بالعائلة؟", o: ["ثري وحيد", "فقير مع العائلة"], s: [25, 75], t: "حياة", m: "صعب" },
  { p: "لو خيروك بين أن تُسجن بريئاً 10 سنوات أو أن تُعاقب على ذنب لم ترتكبه علناً؟", o: ["سجن بريء 10 سنوات", "عقاب علني ظالم"], s: [45, 55], t: "عدل", m: "صعب" },
  { p: "لو خيروك بين أن تعرف سر الكون أو أن تعيش سعيداً بلا معرفة؟", o: ["معرفة سر الكون", "سعادة بلا معرفة"], s: [50, 50], t: "فلسفي", m: "صعب" },
  { p: "لو خيروك بين خوض حرب لا تؤمن بها أو الهروب من وطنك؟", o: ["حرب لا أؤمن بها", "الهروب من الوطن"], s: [40, 60], t: "أخلاق", m: "صعب" },
  { p: "لو خيروك بين أن تُنسى بعد موتك أو أن تُذكر بأفعال سيئة؟", o: ["أن أُنسى", "أن أُذكر بسيئاتي"], s: [60, 40], t: "إرث", m: "صعب" },
  { p: "لو خيروك بين أن تختار لمن تعطي حياتك أو لا تختار ويعطيها الطبيب لشخص عشوائي؟", o: ["أختار لمن أعطيها", "اختيار الطبيب عشوائياً"], s: [70, 30], t: "أخلاق", m: "صعب" },

  // ===== فلسفية (25) =====
  { p: "لو خيروك بين أن تكون حراً بلا هدف أو مقيداً بهدف نبيل؟", o: ["حر بلا هدف", "مقيد بهدف نبيل"], s: [45, 55], t: "فلسفي", m: "فلسفي" },
  { p: "لو خيروك بين المال أو الشهرة؟", o: ["المال", "الشهرة"], s: [70, 30], t: "حياة", m: "فلسفي" },
  { p: "لو خيروك بين الحب أو الحكمة؟", o: ["الحب", "الحكمة"], s: [60, 40], t: "فلسفي", m: "فلسفي" },
  { p: "لو خيروك بين القوة أو اللطف؟", o: ["القوة", "اللطف"], s: [35, 65], t: "فلسفي", m: "فلسفي" },
  { p: "لو خيروك بين أن تكون محقاً وحيداً أو مخطئاً مع الجماعة؟", o: ["محقاً وحيداً", "مخطئاً مع الجماعة"], s: [55, 45], t: "فلسفي", m: "فلسفي" },
  { p: "لو خيروك بين السلام العالمي أو نهاية الفقر؟", o: ["السلام العالمي", "نهاية الفقر"], s: [50, 50], t: "أخلاق", m: "فلسفي" },
  { p: "لو خيروك بين المعرفة المطلقة أو السعادة المطلقة؟", o: ["المعرفة المطلقة", "السعادة المطلقة"], s: [45, 55], t: "فلسفي", m: "فلسفي" },
  { p: "لو خيروك بين خلود الجسد أو خلود الروح؟", o: ["خلود الجسد", "خلود الروح"], s: [25, 75], t: "فلسفي", m: "فلسفي" },
  { p: "لو خيروك بين أن تعيش في الحاضر دائماً أو أن تتأمل الماضي والمستقبل؟", o: ["العيش في الحاضر", "تأمل الماضي والمستقبل"], s: [60, 40], t: "فلسفي", m: "فلسفي" },
  { p: "لو خيروك بين الجمال الداخلي أو الجمال الخارجي؟", o: ["الجمال الداخلي", "الجمال الخارجي"], s: [80, 20], t: "قيم", m: "فلسفي" },
  { p: "لو خيروك بين النجاح بصعوبة أو الفشل بسهولة؟", o: ["نجاح صعب", "فشل سهل"], s: [85, 15], t: "حياة", m: "فلسفي" },
  { p: "لو خيروك بين الفردية أو الجماعة؟", o: ["الفردية", "الجماعة"], s: [40, 60], t: "مجتمع", m: "فلسفي" },
  { p: "لو خيروك بين أن تتبع قلبك أو عقلك؟", o: ["القلب", "العقل"], s: [55, 45], t: "فلسفي", m: "فلسفي" },
  { p: "لو خيروك بين أن تعيش حياة بسيطة هادئة أو حياة مليئة بالمغامرات خطيرة؟", o: ["حياة بسيطة", "حياة مغامرات"], s: [50, 50], t: "حياة", m: "فلسفي" },
  { p: "لو خيروك بين أن يكون لك أثر كبير بعد موتك أو أن تعيش طويلاً بلا أثر؟", o: ["أثر كبير", "حياة طويلة بلا أثر"], s: [60, 40], t: "إرث", m: "فلسفي" },
  { p: "لو خيروك بين العدالة أو الرحمة؟", o: ["العدالة", "الرحمة"], s: [45, 55], t: "قيم", m: "فلسفي" },
  { p: "لو خيروك بين الكمال أو التطور المستمر؟", o: ["الكمال", "التطور المستمر"], s: [30, 70], t: "فلسفي", m: "فلسفي" },
  { p: "لو خيروك بين الفن أو العلم؟", o: ["الفن", "العلم"], s: [40, 60], t: "معرفة", m: "فلسفي" },
  { p: "لو خيروك بين أن تكون محبوباً أو أن تحب؟", o: ["محبوباً", "أن تحب"], s: [50, 50], t: "مشاعر", m: "فلسفي" },
  { p: "لو خيروك بين الحرية أو الأمان؟", o: ["الحرية", "الأمان"], s: [55, 45], t: "مجتمع", m: "فلسفي" },
  { p: "لو خيروك بين الحقيقة أو السعادة؟", o: ["الحقيقة", "السعادة"], s: [50, 50], t: "فلسفي", m: "فلسفي" },
  { p: "لو خيروك بين العقلانية أو العاطفة؟", o: ["العقلانية", "العاطفة"], s: [50, 50], t: "فلسفي", m: "فلسفي" },
  { p: "لو خيروك بين أن تكون منظماً أو عفوياً؟", o: ["منظماً", "عفوياً"], s: [55, 45], t: "شخصية", m: "فلسفي" },
  { p: "لو خيروك بين أن تحلم بحياة أفضل أو أن تقبل بحياتك كما هي؟", o: ["الحلم بحياة أفضل", "قبول الحياة كما هي"], s: [65, 35], t: "فلسفي", m: "فلسفي" },
  { p: "لو خيروك بين أن تكون منظّر عظيم أو منفّذ عادي؟", o: ["منظّر عظيم", "منفّذ عادي"], s: [40, 60], t: "حياة", m: "فلسفي" },
];
...
const loyState = {
  ...
  currentQuestion: null,
  answered: false,
  optionsRevealed: false,  // هل ضغط المستخدم "أجب الآن!" لرؤية الخيارات
  selectedOption: null,
...
function startLoyGame() {
  ...
  document.getElementById("loy-score").textContent = "0";
  document.getElementById("loy-streak").textContent = "0";
  document.getElementById("loy-streak-chip").style.display = "none";
...
async function loadLoyQuestion() {
  loyState.answered = false;
  loyState.selectedOption = null;
  loyState.optionsRevealed = false;
  document.getElementById("loy-reveal-panel").style.display = "none";
  document.getElementById("loy-actions").style.display = "none";
  document.getElementById("loy-loading-next").style.display = "";

  // أعد ضبط المرحلة: السؤال ظاهر، الخيارات مخفية، الزر فعّال
  const stage = document.getElementById("loy-question-stage");
  const grid = document.getElementById("loy-options-grid");
  const cta = document.getElementById("loy-answer-cta");
  const answerBtn = document.getElementById("loy-answer-now-btn");
  if (stage) { stage.classList.remove("stage-hidden"); stage.style.display = ""; }
  if (grid) { grid.style.display = "none"; grid.classList.remove("opts-revealed"); }
  if (cta) cta.style.display = "";
  if (answerBtn) { answerBtn.disabled = false; answerBtn.classList.remove("answered"); }

  // أعد ضبط كرت السؤال
  document.getElementById("loy-question-text").textContent = "جارٍ تحميل السؤال…";
  document.getElementById("loy-options-grid").innerHTML = "";
  document.getElementById("loy-topic-tag").textContent = "—";
  document.getElementById("loy-mood-tag").textContent = "—";
  document.getElementById("loy-source-tag").textContent = "—";
...
async function fetchLoyQuestionFromAI() {
  ...
  // اختر عدد الخيارات: 2 (80٪ من الوقت) أو 3 (20٪)
  const numOptions = Math.random() < 0.8 ? 2 : 3;

  const systemPrompt = "أنت مولّد أسئلة للعبة 'لو خيروك' العربية. كل سؤال يبدأ بعبارة 'لو خيروك بين...'، يضع المستخدم في موقف اختيار بين خيارين أو أكثر بدون إجابة صحيحة. أعطِ النتيجة بصيغة JSON صارمة فقط.";
  const userPrompt = `ولّد سؤالاً واحداً للعبة "لو خيروك" يدور تحديداً حول الكلمة المفتاحية: «${keyword}»\nضمن مجال: «${topic}»\nبمزاج: ${mood}.\n\nالشروط:\n- السؤال يبدأ بعبارة "لو خيروك بين..." ثم يصف الموقف.\n- ${numOptions === 2 ? "خياران فقط (2)." : "ثلاثة خيارات (3)."}\n- الخيارات متقاربة في الجاذبية، لا يوجد خيار "صحيح".\n- أضف مصفوفة "percentages" تمثّل تقديراً لنسبة اختيار الناس لكل خيار، بحيث يكون مجموعها 100.\n- النسب ينبغي أن تعكس رأياً عاماً معقولاً (لا تجعلها 50/50 دائماً).\n- أضف حقل "topic" يعكس الموضوع وحقل "mood" يعكس المزاج.\n- اللغة بسيطة ومفهومة مع لمسة من المرح.\n- تجنّب المواضيع الدينية أو السياسية الحساسة.\n\nأعطِ النتيجة بصيغة JSON فقط بالشكل:\n{"prompt":"لو خيروك بين...","options":["خيار1","خيار2"${numOptions === 3 ? ',"خيار3"' : ""}],"percentages":[60,40${numOptions === 3 ? ",0" : ""}],"topic":"الموضوع","mood":"${mood}"}`;
  ...
  try {
    ...
    if (
      ...
      Array.isArray(obj.options) && obj.options.length >= 2 && obj.options.length <= 4 &&
      obj.options.every(o => typeof o === "string" && o.trim().length > 0) &&
      Array.isArray(obj.percentages) && obj.percentages.length === obj.options.length
    ) {
      // تأكد أن مجموع percentages = 100 تقريباً
      let sum = obj.percentages.reduce((a, b) => a + Number(b), 0);
      if (sum <= 0) {
        // قسّم بالتساوي
        const eq = Math.floor(100 / obj.options.length);
        obj.percentages = obj.options.map((_, i) => i === 0 ? 100 - eq * (obj.options.length - 1) : eq);
...
function renderLoyQuestion(q) {
  // إزالة "لو خيروك" من بداية نص السؤال لتجنب التكرار مع العنوان الكبير
  let promptText = (q.prompt || "").trim();
  promptText = promptText.replace(/^لو خيروك\s*[:：\-–—]?\s*/i, "");
  promptText = promptText.replace(/^بين\s*/i, "بين "); // ضمان أن يبدأ بـ "بين"
  if (!promptText) promptText = q.prompt;
  document.getElementById("loy-question-text").textContent = promptText;
  document.getElementById("loy-topic-tag").textContent = q.topic;
  document.getElementById("loy-mood-tag").textContent = q.mood;
  document.getElementById("loy-source-tag").textContent = q.source === "ai" ? "🤖 AI" : "📚 بنك";

  // لوّن كرت السؤال حسب المزاج
  const card = document.getElementById("loy-question-card");
  card.classList.remove("mood-mafhik", "mood-gharib", "mood-saab", "mood-falsafi");
  if (q.mood === "مضحك") card.classList.add("mood-mafhik");
  else if (q.mood === "غريب") card.classList.add("mood-gharib");
  else if (q.mood === "صعب") card.classList.add("mood-saab");
  else if (q.mood === "فلسفي") card.classList.add("mood-falsafi");
...
/* ====== إظهار الخيارات بعد الضغط على "أجب الآن!" ====== */
function revealLoyOptions() {
  if (loyState.optionsRevealed) return;
  // امنع الضغط قبل اكتمال تحميل السؤال
  if (!loyState.currentQuestion) return;
  loyState.optionsRevealed = true;

  const stage = document.getElementById("loy-question-stage");
  const grid = document.getElementById("loy-options-grid");
  const answerBtn = document.getElementById("loy-answer-now-btn");

  // علّل الزر بأنه تم الضغط عليه
  if (answerBtn) {
    answerBtn.disabled = true;
    answerBtn.classList.add("answered");
  }

  // أطلق حركة إخفاء المرحلة (fade + slide-up)
  if (stage) stage.classList.add("stage-hidden");

  // بعد انتهاء حركة الإخفاء (~380ms)، أخفِ المرحلة وأظهر الخيارات
  setTimeout(() => {
    if (stage) stage.style.display = "none";
    if (grid) {
      grid.style.display = "";
      grid.classList.add("opts-revealed");
      // أعد تشغيل أنميشن دخول البطاقات
      grid.querySelectorAll(".loy-option-card").forEach((card) => {
...
function loyAnswer(index) {
  ...
  // نقاط: +1 لكل إجابة، +1 إضافي لكل إجابة في السلسلة (>0)
  loyState.streak++;
  if (loyState.streak > loyState.bestStreak) loyState.bestStreak = loyState.streak;
  const basePoint = 10;
  const streakBonus = Math.min(loyState.streak - 1, 10) * 2;
  const earned = basePoint + streakBonus;
  loyState.score += earned;

  document.getElementById("loy-score").textContent = loyState.score;
  document.getElementById("loy-streak").textContent = loyState.streak;
  document.getElementById("loy-streak-chip").style.display = loyState.streak >= 2 ? "" : "none";
  ...
  reveal.innerHTML = `
    <div class="loy-reveal-card">
      <div class="loy-reveal-row">
        ...
        <span class="loy-reveal-value">${escapeHtml(q.options[index])}</span>
      </div>
      <div class="loy-reveal-row">
        <span class="loy-reveal-label">📊 نسبة من وافقوك:</span>
        <span class="loy-reveal-value">${q.percentages[index] || 0}% من الناس</span>
      </div>
      <div class="loy-reveal-row">
        <span class="loy-reveal-label">🏆 نقاط هذه الجولة:</span>
        <span class="loy-reveal-value">+${earned} نقطة${streakBonus > 0 ? ` (مكافأة سلسلة +${streakBonus})` : ""}</span>
      </div>
      <div class="loy-reveal-row loy-comment-row">
        <span class="loy-reveal-comment">${getLoyComment(q.percentages[index] || 0)}</span>
      </div>
    </div>
  `;
...
/* ====== تعليق لطيف حسب النسبة ====== */
function getLoyComment(percent) {
...
function endLoyGame() {
  ...
  let subtitle = "";
  if (loyState.totalQuestions === 0) {
    subtitle = `أجبت عن ${loyState.currentIndex} سؤالاً وجمعت ${loyState.score} نقطة.`;
  } else {
    subtitle = `أجبت عن ${loyState.currentIndex} سؤالاً وجمعت ${loyState.score} نقطة.`;
  }
  document.getElementById("loy-end-subtitle").textContent = subtitle;

  const statsEl = document.getElementById("loy-end-stats");
  statsEl.innerHTML = `
    <div class="end-stat me">
      <span class="stat-label">إجمالي النقاط</span>
      <span class="stat-value">${loyState.score}</span>
    </div>
    <div class="end-stat">
      <span class="stat-label">عدد الأسئلة</span>
      <span class="stat-value">${loyState.currentIndex}</span>
    </div>
    <div class="end-stat">
      <span class="stat-label">أطول سلسلة 🔥</span>
      <span class="stat-value">${loyState.bestStreak}</span>
    </div>
  `;
  ...
  if (name === "loy-intro") {
    ...
    if (hint) {
      if (state.apiKey) {
        ...
        hint.textContent = "💡 لم تُدخل مفتاح OpenRouter. ستُستخدم أسئلة البنك المدمج (100 سؤال متنوع). أدخل المفتاح من الإعدادات لأسئلة لا نهائية.";
